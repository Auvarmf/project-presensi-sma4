                            ...
                            <div class="card-body p-3 overflow-auto">
                                ...
                                <form action="{{ route('jadwal.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="id_mapel" name="id_mapel"
                                                class="form-select @error('id_mapel') is-invalid @enderror"
                                            ...
                                            <select id="id_kelas" name="id_kelas"
                                                ...
                                                @foreach ($data_kelas as $kelas)
                                                    <option value="{{ $kelas->id }}"
                                                        ...
                                                        {{ $kelas->jenjang_kelas }} {{ $kelas->kategori_kelas }}</option>
                                                @endforeach
                                            </select>
                                            @error('id_kelas')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="waktu_mulai" name="waktu_mulai" type="time"
